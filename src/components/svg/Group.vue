<template>
  <g v-bind="g.svgAttrs.svgAttrs">
    <template v-for="c in childGroups">
      <Group v-bind:g="c"></Group>
    </template>
    <template v-for="c in boxes">
      <Box v-bind:shape="c"></Box>
    </template>
    <template v-for="c in cylinders">
      <Cylinder v-bind:shape="c"></Cylinder>
    </template>
    <template v-for="c in persons">
      <Person v-bind:shape="c"></Person>
    </template>
    <template v-for="c in arrows">
      <Arrow v-bind:shape="c"></Arrow>
    </template>
